...
public abstract class AbstractC0916a {
    ...
    public static final byte[] f14457b = {53, 54, 43, 44, 45, 46, 47, 48, 37, 38};

    /* renamed from: c, reason: collision with root package name */
    public static final byte[] f14458c = {55, 56, 57, 58, 59, 60, 49, 50, 51, 52};

    /* renamed from: d, reason: collision with root package name */
    public static final byte[] f14459d = {39, 40, 41, 42, 31, 32};

    /* renamed from: e, reason: collision with root package name */
    public static final byte[] f14460e = {33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2};

    /* renamed from: f, reason: collision with root package name */
    public static final byte[][] f14461f = {new byte[]{39, 40, 41, 42, 31, 32}, new byte[]{33, 34, 35, 36, 25, 26}, new byte[]{27, 28, 29, 30, 19, 20}, new byte[]{21, 22, 23, 24, 13, 14}, new byte[]{15, 16, 17, 18, 7, 8}, new byte[]{9, 10, 11, 12, 1, 2}};
    ...
    public static int a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i10 = 0; i10 < bArr2.length; i10++) {
            int i11 = bArr2[i10] - 1;
            i7 += (((1 << (5 - (i11 % 6))) & bArr[i11 / 6]) == 0 ? 0 : 1) << ((bArr2.length - i10) - 1);
        }
        return i7;
    }

    /* JADX WARN: Failed to find 'out' block for switch in B:5:0x001a. Please report as an issue. */
    public static String b(int i7, byte[] bArr, int i10) {
        ...
        int i14 = 0;
        while (i11 < i7 + i10) {
            char charAt = g[i13].charAt(bArr[i11]);
            switch (charAt) {
                case 65520:
                case 65521:
                case 65522:
