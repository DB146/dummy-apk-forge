...
public final class PathIteratorPreApi34Impl {
    ...
    private final native long createInternalPathIterator(Path path, int i7, float f4);
    ...
    @FastNative
    private final native int internalPathIteratorNext(long j, float[] fArr, int i7);
