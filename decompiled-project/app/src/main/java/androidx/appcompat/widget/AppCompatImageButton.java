...
public class AppCompatImageButton extends ImageButton {
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f12988b.f471b).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        s sVar = this.f12988b;
        if (sVar != null && drawable != null && !this.f12989c) {
