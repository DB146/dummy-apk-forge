...
public class InstrumentationActivityInvoker$EmptyFloatingActivity extends Activity {
    ...
    public final BroadcastReceiver f13728a = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker$EmptyFloatingActivity.1
    ...
    public final void onCreate(Bundle bundle) {
        ...
        BroadcastReceiver broadcastReceiver = this.f13728a;
    ...
    public final void onDestroy() {
        super.onDestroy();
        unregisterReceiver(this.f13728a);
    }
