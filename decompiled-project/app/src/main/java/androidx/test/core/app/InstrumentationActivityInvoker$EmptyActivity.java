...
public class InstrumentationActivityInvoker$EmptyActivity extends Activity {
    ...
    public final BroadcastReceiver f13726a = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker$EmptyActivity.1
    ...
    public final void onCreate(Bundle bundle) {
        ...
        BroadcastReceiver broadcastReceiver = this.f13726a;
    ...
    public final void onDestroy() {
        super.onDestroy();
        unregisterReceiver(this.f13726a);
    }
