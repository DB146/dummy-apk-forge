...
public abstract class u extends b implements cb.b {
    ...
    public volatile ab.f f3138N0;

    /* renamed from: O0, reason: collision with root package name */
    public final Object f3139O0 = new Object();

    /* renamed from: P0, reason: collision with root package name */
    public boolean f3140P0 = false;

    @Override // W1.C
    public final Context C() {
        if (super.C() == null && !this.f3137M0) {
            return null;
        }
        H0();
        return this.f3136L0;
    ...
    public final void H0() {
        if (this.f3136L0 == null) {
            this.f3136L0 = new ab.j(super.C(), this);
            this.f3137M0 = com.bumptech.glide.d.r(super.C());
        }
    }
    ...
    public final Object e() {
        if (this.f3138N0 == null) {
            synchronized (this.f3139O0) {
                try {
                    if (this.f3138N0 == null) {
                        this.f3138N0 = new ab.f(this);
                    }
                } finally {
                }
            }
        }
        return this.f3138N0.e();
    }
