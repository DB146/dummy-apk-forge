...
public class BlurTask {
    ...
    public void execute() {
        THREAD_POOL.execute(new Runnable() { // from class: com.kt.apps.core.utils.blurry.BlurTask.1
            @Override // java.lang.Runnable
            public void run() {
                final Context context = (Context) BlurTask.this.contextWeakRef.get();
                if (BlurTask.this.callback != null) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.kt.apps.core.utils.blurry.BlurTask.1.1
                        @Override // java.lang.Runnable
                        public void run() {
