...
public class Blur {
    public static Bitmap of(Context context, Bitmap bitmap, BlurFactor blurFactor) {
        Bitmap stack;
        int i7 = blurFactor.width;
        int i10 = blurFactor.sampling;
        int i11 = i7 / i10;
        int i12 = blurFactor.height / i10;
        if (Helper.hasZero(i11, i12)) {
            return null;
        }
        Bitmap createBitmap = Bitmap.createBitmap(i11, i12, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        int i13 = blurFactor.sampling;
    ...
    */
    private static Bitmap rs(Context context, Bitmap bitmap, int i7) {
        ...
        try {
            r02 = ScriptIntrinsicBlur.create(create, Element.U8_4(create));
            r02.setInput(allocation2);
            r02.setRadius(i7);
            r02.forEach(allocation3);
    ...
    private static Bitmap stack(Bitmap bitmap, int i7, boolean z8) {
        int[] iArr;
        int i10 = i7;
        ...
        while (i21 < height) {
            ...
            while (i33 <= i10) {
                int i35 = i13;
                int[] iArr9 = iArr6;
                int i36 = iArr2[Math.min(i12, Math.max(i33, 0)) + i22];
