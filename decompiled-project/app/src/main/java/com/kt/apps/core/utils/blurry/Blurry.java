...
import com.kt.apps.core.utils.blurry.BlurTask;
...
public class Blurry {
    ...
    public static class BitmapComposer {
        ...
        public BitmapComposer(Context context, Bitmap bitmap, BlurFactor blurFactor, boolean z8) {
        ...
        public void into(final ImageView imageView) {
            ...
            if (this.async) {
                new BlurTask(imageView.getContext(), this.bitmap, this.factor, new BlurTask.Callback() { // from class: com.kt.apps.core.utils.blurry.Blurry.BitmapComposer.1
                    @Override // com.kt.apps.core.utils.blurry.BlurTask.Callback
    ...
    public static class Composer {
        ...
        public void onto(final ViewGroup viewGroup) {
            ...
            if (this.async) {
                new BlurTask(viewGroup, this.factor, new BlurTask.Callback() { // from class: com.kt.apps.core.utils.blurry.Blurry.Composer.1
                    @Override // com.kt.apps.core.utils.blurry.BlurTask.Callback
                    public void done(Bitmap bitmap) {
        ...
        public Composer radius(int i7) {
            this.factor.radius = i7;
            return this;
        }

        public Composer sampling(int i7) {
            this.factor.sampling = i7;
            return this;
        }
    }
    ...
    public static class ImageComposer {
        ...
        public ImageComposer(Context context, View view, BlurFactor blurFactor, boolean z8) {
            this.context = context;
            this.capture = view;
            this.factor = blurFactor;
            this.async = z8;
        ...
        public void into(final ImageView imageView) {
            ...
            this.factor.height = this.capture.getMeasuredHeight();
            if (this.async) {
                new BlurTask(this.capture, this.factor, new BlurTask.Callback() { // from class: com.kt.apps.core.utils.blurry.Blurry.ImageComposer.1
                    @Override // com.kt.apps.core.utils.blurry.BlurTask.Callback
                    public void done(Bitmap bitmap) {
