...
public abstract class zzba {
    ...
    public static zzba create(AdsRequest adsRequest, String str, zzaw zzawVar, List<zzbo> list, Map<String, String> map, String str2, zzbu zzbuVar, ImaSdkSettings imaSdkSettings, zzeb zzebVar, boolean z8, boolean z10, String str3, zzbc zzbcVar, AdDisplayContainer adDisplayContainer) {
        ...
        builder.isAndroidTvAdsFramework(Boolean.valueOf(z10));
        ...
        builder.supportsExternalNavigation(Boolean.valueOf(!z8));
    ...
    public static zzba createFromStreamRequest(StreamRequest streamRequest, String str, zzaw zzawVar, List<zzbo> list, Map<String, String> map, String str2, zzbu zzbuVar, ImaSdkSettings imaSdkSettings, zzeb zzebVar, boolean z8, boolean z10, String str3, zzbc zzbcVar, StreamDisplayContainer streamDisplayContainer) {
