...
public final class zzaal<T> extends zzaah<T> {
    ...
    public zzaal(zzwy zzwyVar, zzwq zzwqVar, zzwm zzwmVar, zzact zzactVar, zzxj zzxjVar, boolean z8) {
        this.zzb = zzwyVar;
        this.zzc = zzwqVar;
        this.zza = zzwmVar;
        this.zzd = zzactVar;
    ...
    public final void write(zzacx zzacxVar, T t5) {
        ...
        } else if (this.zzg && t5 == null) {
            zzacxVar.zzf();
        } else {
            ((zzabg) zzaby.zzV).write(zzacxVar, zzwyVar.zza(t5, this.zzd.zzd(), this.zzf));
        }
    }
