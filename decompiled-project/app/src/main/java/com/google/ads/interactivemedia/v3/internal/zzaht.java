...
public final class zzaht {
    ...
    public static void zzD(Object obj, long j, byte b2) {
        zzahs zzahsVar = zzf;
        long j10 = (-4) & j;
        int i7 = zzahsVar.zza.getInt(obj, j10);
        int i10 = ((~((int) j)) & 3) << 3;
        zzahsVar.zza.putInt(obj, j10, ((255 & b2) << i10) | (i7 & (~(255 << i10))));
    }
    ...
    public static void zzE(Object obj, long j, byte b2) {
        ...
        long j10 = (-4) & j;
        int i7 = (((int) j) & 3) << 3;
        zzahsVar.zza.putInt(obj, j10, ((255 & b2) << i7) | (zzahsVar.zza.getInt(obj, j10) & (~(255 << i7))));
    }
