...
final class zzvv extends zzvs implements ScheduledExecutorService, zzvr {
    ...
    public final /* bridge */ /* synthetic */ ScheduledFuture scheduleAtFixedRate(Runnable runnable, long j, long j10, TimeUnit timeUnit) {
        ...
        return new zzvt(zzvuVar, this.zza.scheduleAtFixedRate(zzvuVar, j, j10, timeUnit));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final /* bridge */ /* synthetic */ ScheduledFuture scheduleWithFixedDelay(Runnable runnable, long j, long j10, TimeUnit timeUnit) {
        zzvu zzvuVar = new zzvu(runnable);
        return new zzvt(zzvuVar, this.zza.scheduleWithFixedDelay(zzvuVar, j, j10, timeUnit));
    }
}
