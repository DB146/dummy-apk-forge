...
final class zzu implements zzaz {
    ...
    @Override // com.google.ads.interactivemedia.v3.impl.data.zzaz
    public zzaz contentDuration(Float f4) {
    ...
    @Override // com.google.ads.interactivemedia.v3.impl.data.zzaz
    public zzaz liveStreamPrefetchSeconds(Float f4) {
        this.liveStreamPrefetchSeconds = f4;
        return this;
    }
    ...
    @Override // com.google.ads.interactivemedia.v3.impl.data.zzaz
    public zzaz vastLoadTimeout(Float f4) {
