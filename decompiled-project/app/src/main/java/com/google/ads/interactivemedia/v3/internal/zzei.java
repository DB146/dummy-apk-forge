...
public final class zzei implements AdsRequest {
    ...
    public final void setAdWillAutoPlay(boolean z8) {
        this.zze = z8 ? zzef.AUTO : zzef.CLICK;
    }

    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setAdWillPlayMuted(boolean z8) {
        this.zzf = z8 ? zzeh.MUTED : zzeh.UNMUTED;
    }
    ...
    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setContentDuration(float f4) {
        this.zzh = Float.valueOf(f4);
    }
    ...
    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setLiveStreamPrefetchSeconds(float f4) {
        this.zzm = Float.valueOf(f4);
    }
    ...
    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setVastLoadTimeout(float f4) {
        this.zzl = Float.valueOf(f4);
    }
