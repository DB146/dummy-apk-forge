...
public final class zzji implements zzjl {
    ...
    public static synchronized zzji zza(String str, Context context, boolean z8, boolean z10) {
        zzji zzb2;
        synchronized (zzji.class) {
            zzb2 = zzb(str, context, Executors.newCachedThreadPool(), z8, z10);
        }
        return zzb2;
    }

    @Deprecated
    public static synchronized zzji zzb(String str, Context context, Executor executor, boolean z8, boolean z10) {
        zzji zzjiVar;
        synchronized (zzji.class) {
            try {
                if (zzb == null) {
                    ...
                    zza.zzc(z8);
                    zzpa zzd = zza.zzd();
                    zzoy zza2 = zzoy.zza(context, executor, z10);
    ...
    public static /* bridge */ /* synthetic */ void zzj(zzji zzjiVar) {
        ...
        try {
            try {
                ...
                zzjiVar.zzh.zzc(4002, System.currentTimeMillis() - currentTimeMillis, e2);
                countDownLatch = zzjiVar.zzk;
            }
