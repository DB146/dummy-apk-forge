...
public final class zzqi {
    ...
    public zzqi(Context context, int i7, zzpr zzprVar, boolean z8) {
        this.zzf = false;
        this.zzb = context;
    ...
    private final zzmp zzk(int i7) {
        ...
        try {
            byte[] i10 = c.i(string);
            return zzmp.zzh(zzadr.zzs(i10, 0, i10.length), this.zzf ? zzaef.zza() : zzaef.zzb());
        } catch (zzafc unused) {
            return null;
