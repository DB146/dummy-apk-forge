...
public class zzahf extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i10 <= i7) {
            int i11 = (i10 + i7) / 2;
            int compareTo2 = comparable.compareTo(((zzagz) this.zzb.get(i11)).zza());
            if (compareTo2 < 0) {
                i7 = i11 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final int hashCode() {
        ...
        for (int i10 = 0; i10 < zzb; i10++) {
            i7 += ((zzagz) this.zzb.get(i10)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i10 = this.zza;
        if (size == i10) {
            zzagz zzagzVar = (zzagz) this.zzb.remove(i10 - 1);
