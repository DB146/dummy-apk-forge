        ...
        if (zza instanceof zzxi) {
            ...
            if (zza instanceof zzwy) {
                ...
                if (!(zza instanceof zzwq)) {
                    throw new IllegalArgumentException(o.n("Invalid attempt to bind an instance of ", zza.getClass().getName(), " as a @JsonAdapter for ", zzactVar.toString(), ". @JsonAdapter value must be a TypeAdapter, TypeAdapterFactory, JsonSerializer or JsonDeserializer."));
                }
                zzwyVar = null;
            }
