...
public final class zzaei {
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x00d6 A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static k zza(Status status) {
        int i7 = status.f14897a;
        String zza2 = zza(zzb(i7), status);
        if (i7 == 17020) {
            return new k(zza("A network error (such as timeout, interrupted connection or unreachable host) has occurred.", status));
        }
        if (i7 != 17021) {
            if (i7 != 17051) {
                if (i7 == 17052) {
                ...
                switch (i7) {
                    ...
                    case 18001:
                    case 18002:
                        return new i(zza(i7), zza2);
                    case 17007:
                    case 17012:
                        return new i(zza(i7), zza2);
                    case 17010:
                        return new k(zza("We have blocked all requests from this device due to unusual activity. Try again later.", status));
                    case 17080:
                        return new k(zza2);
                    case 17200:
                        return new i(zza(i7), zza2);
                    case 17495:
                        return new k(zza("Please sign in before trying to get a token.", status));
                    case 17499:
                                                    ...
                                                    default:
                                                        switch (i7) {
                                                            ...
                                                            default:
                                                                switch (i7) {
                                                                    case 17061:
                                                                        return new k(zza("There was a failure in the connection between the web widget and the Firebase Auth backend.", status));
                                                                    case 17062:
                                                                    case 17065:
                                                                        break;
                                                                    case 17063:
    ...
    public static k zza(Status status, AbstractC1712c abstractC1712c, String str, String str2) {
        int i7 = status.f14897a;
        if (i7 != 17012 && i7 != 17007 && i7 != 17025) {
            return zza(status);
        }
        return new i(zza(i7), zza(zzb(i7), status));
    }

    private static String zza(int i7) {
        Pair<String, String> pair = zza.get(i7);
        return pair != null ? (String) pair.first : "INTERNAL_ERROR";
    }

    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.f14898b) ? str : String.format(c.h(str, " [ %s ]"), status.f14898b);
    }

    /* JADX WARN: Type inference failed for: r1v1, types: [n7.i, n7.j] */
    public static j zza(FirebaseAuth firebaseAuth, zzaaj zzaajVar, l lVar) {
        zzw.zza(firebaseAuth);
        zzw.zza(zzaajVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<q> zzc = zzaajVar.zzc();
        ...
        List<q> zzc2 = zzaajVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (q qVar2 : zzc2) {
            if (qVar2 instanceof y) {
                arrayList2.add((y) qVar2);
            }
        }
        List<q> zzc3 = zzaajVar.zzc();
        String zzb = zzaajVar.zzb();
        G.g(zzc3);
        G.d(zzb);
        ...
        for (q qVar3 : zzc3) {
            if (qVar3 instanceof v) {
                arrayList3.add((v) qVar3);
            } else {
                if (!(qVar3 instanceof y)) {
                    throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(qVar3.t()));
                }
                arrayList4.add((y) qVar3);
            }
        }
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f21290a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }

    private static String zzb(int i7) {
        Pair<String, String> pair = zza.get(i7);
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f21290a.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f21290a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f21290a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
}
