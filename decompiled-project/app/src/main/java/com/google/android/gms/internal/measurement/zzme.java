...
public abstract class zzme<MessageType extends zzme<MessageType, BuilderType>, BuilderType extends zzma<MessageType, BuilderType>> extends zzkr<MessageType, BuilderType> {
    ...
    public static /* synthetic */ boolean zzcx(zzme zzmeVar, boolean z8) {
        return zzd(zzmeVar, false);
    }

    public static final boolean zzd(zzme zzmeVar, boolean z8) {
    ...
    public final int zzcd(zznw zznwVar) {
        ...
        int i7 = this.zzb & f.API_PRIORITY_OTHER;
    ...
    public final void zzcm(int i7) {
        this.zzb = (this.zzb & Integer.MIN_VALUE) | f.API_PRIORITY_OTHER;
    }
    ...
    public final int zzcn() {
        ...
        if (zzcf()) {
            ...
            i7 = this.zzb & f.API_PRIORITY_OTHER;
            if (i7 == Integer.MAX_VALUE) {
                i7 = zzc(null);
                if (i7 < 0) {
                    StringBuilder sb3 = new StringBuilder(String.valueOf(i7).length() + 42);
                    sb3.append("serialized size must be non-negative, was ");
                    sb3.append(i7);
                    throw new IllegalStateException(sb3.toString());
                }
