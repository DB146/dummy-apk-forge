...
public final class zzbu extends zzbi {
    ...
    @Override // com.google.android.gms.internal.fido.zzbi
    public final zzbi zzm(Object obj, boolean z8) {
        return zzu(0, zzs(obj, z8));
    }

    @Override // com.google.android.gms.internal.fido.zzbi
    public final zzbi zzo(Object obj, boolean z8, Object obj2, boolean z10) {
        return zzp(obj, z8).zzm(obj2, z10);
    }

    @Override // com.google.android.gms.internal.fido.zzbi
    public final zzbi zzp(Object obj, boolean z8) {
        return zzu(zzt(obj, z8), this.zzd.size());
    }
    ...
    public final int zzs(Object obj, boolean z8) {
    ...
    public final int zzt(Object obj, boolean z8) {
        zzaz zzazVar = this.zzd;
        obj.getClass();
        int binarySearch = Collections.binarySearch(zzazVar, obj, ((zzbi) this).zza);
    ...
    public final zzbu zzu(int i7, int i10) {
        if (i7 == 0) {
        ...
        return i7 < i10 ? new zzbu(this.zzd.subList(i7, i10), ((zzbi) this).zza) : zzbi.zzq(((zzbi) this).zza);
    }
}
