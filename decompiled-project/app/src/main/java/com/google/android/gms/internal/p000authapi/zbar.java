...
public final class zbar {
    ...
    static {
        ...
        zbh = dVar8;
        d dVar9 = new d("auth_api_credentials_verify_with_google", 1L);
        zbi = dVar9;
        d dVar10 = new d("auth_api_credentials_credential_provider", 1L);
        zbj = dVar10;
        zbk = new d[]{dVar, dVar2, dVar3, dVar4, dVar5, dVar6, dVar7, dVar8, dVar9, dVar10};
    }
}
