...
final class zzps {
    ...
    static {
        ...
        if (zzprVar3 != null) {
            try {
                Class<?> cls2 = zzprVar3.zza.getClass();
            ...
            if (zzB() != null) {
                ...
                if (zzprVar != null) {
                    try {
                        Class<?> cls3 = zzprVar.zza.getClass();
    ...
    public static void zzD(Object obj, long j, byte b2) {
        zzpr zzprVar = zzf;
        long j10 = (-4) & j;
        int i7 = zzprVar.zza.getInt(obj, j10);
        int i10 = ((~((int) j)) & 3) << 3;
        zzprVar.zza.putInt(obj, j10, ((255 & b2) << i10) | (i7 & (~(255 << i10))));
    }
    ...
    public static void zzE(Object obj, long j, byte b2) {
        ...
        long j10 = (-4) & j;
        int i7 = (((int) j) & 3) << 3;
        zzprVar.zza.putInt(obj, j10, ((255 & b2) << i7) | (zzprVar.zza.getInt(obj, j10) & (~(255 << i7))));
    }
