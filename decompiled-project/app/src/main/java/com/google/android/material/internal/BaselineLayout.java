...
public class BaselineLayout extends ViewGroup {
    ...
    public final void onLayout(boolean z8, int i7, int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int baseline = (this.f15401a == -1 || childAt.getBaseline() == -1) ? paddingTop : (this.f15401a + paddingTop) - childAt.getBaseline();
    ...
    public final void onMeasure(int i7, int i10) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(i12, getSuggestedMinimumWidth()), i7, i13), View.resolveSizeAndState(Math.max(i11, getSuggestedMinimumHeight()), i10, i13 << 16));
    }
}
