...
public final class zzni {
    ...
    private static zznl zza(zznl zznlVar, zznl zznlVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? zznl.zza : zza(zznlVar, bigInteger, bigInteger2);
        }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ...
        zza(generator, curve);
        BigInteger a9 = eCParameterSpec.getCurve().getA();
        ...
        for (int bitLength = bigInteger.bitLength(); bitLength >= 0; bitLength--) {
            if (bigInteger.testBit(bitLength)) {
                zza3 = zza(zza3, zza4, a9, zza2);
                zza4 = zza(zza4, a9, zza2);
            } else {
                zza4 = zza(zza3, zza4, a9, zza2);
                zza3 = zza(zza3, a9, zza2);
            }
        }
        if (zza3.zza()) {
