...
public final class zzaf extends zzacz implements zzaeg {
    ...
    public static /* synthetic */ void zzaf(zzaf zzafVar, boolean z8) {
        zzafVar.zzg |= 524288;
        zzafVar.zzaP = z8;
    }
    ...
    public static /* synthetic */ void zzaj(zzaf zzafVar, int i7) {
        zzafVar.zzX = i7 - 1;
        zzafVar.zzf |= 1024;
    }

    public static /* synthetic */ void zzak(zzaf zzafVar, int i7) {
        zzafVar.zzY = i7 - 1;
        zzafVar.zzf |= 2048;
    }

    public static /* synthetic */ void zzal(zzaf zzafVar, int i7) {
        zzafVar.zzae = i7 - 1;
        zzafVar.zzf |= 131072;
    }

    public static /* synthetic */ void zzam(zzaf zzafVar, int i7) {
        zzafVar.zzax = i7 - 1;
        zzafVar.zzg |= 8;
    }

    public static /* synthetic */ void zzan(zzaf zzafVar, int i7) {
        zzafVar.zzay = i7 - 1;
        zzafVar.zzg |= 16;
    }

    public static /* synthetic */ void zzao(zzaf zzafVar, int i7) {
        zzafVar.zzaO = 5;
        zzafVar.zzg |= 262144;
    }

    public static zzaf zzd(byte[] bArr, zzacm zzacmVar) {
