...
public final class a {
    ...
    private static final Map f15675a;

    /* renamed from: b, reason: collision with root package name */
    private static final Map f15676b;
    ...
    public static String a(int i7) {
        ...
        Map map2 = f15676b;
        return !map2.containsKey(valueOf) ? "" : c.j((String) map.get(valueOf), " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/IntegrityErrorCode.html#", (String) map2.get(valueOf), ")");
    }
}
