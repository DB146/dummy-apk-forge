...
public final class zzgh implements zzgx {
    ...
    public final void zza(int i7, zzgd zzgdVar, zzue... zzueVarArr) {
        ...
        try {
            zzgdVar.zzc().zze(i7, zza2 instanceof String ? String.valueOf(((String) zza2).charAt(intValue)) : zza2 instanceof List ? ((List) zza2).get(intValue) : Array.get(zza2, intValue));
        } catch (Exception e2) {
            if (!(e2 instanceof ArrayIndexOutOfBoundsException)) {
                throw new zzce(4, 23, e2);
            }
