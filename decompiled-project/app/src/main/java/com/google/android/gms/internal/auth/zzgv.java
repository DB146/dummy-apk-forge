...
public class zzgv extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i10 = 0;
        if (i7 >= 0) {
            int compareTo = comparable.compareTo(((zzgp) this.zzb.get(i7)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i10 <= i7) {
            int i11 = (i10 + i7) / 2;
            int compareTo2 = comparable.compareTo(((zzgp) this.zzb.get(i11)).zza());
            if (compareTo2 < 0) {
                i7 = i11 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final int hashCode() {
        ...
        for (int i10 = 0; i10 < zzb; i10++) {
            i7 += ((zzgp) this.zzb.get(i10)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i10 = this.zza;
        if (size == i10) {
            zzgp zzgpVar = (zzgp) this.zzb.remove(i10 - 1);
