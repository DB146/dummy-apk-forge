...
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b2, byte b10, byte b11, byte b12, char[] cArr, int i7) {
        if (!zze(b10)) {
    ...
    public static /* bridge */ /* synthetic */ void zzb(byte b2, byte b10, byte b11, char[] cArr, int i7) {
        if (!zze(b10)) {
            if (b2 == -32) {
                if (b10 >= -96) {
                    b2 = -32;
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b2, byte b10, char[] cArr, int i7) {
        if (b2 < -62 || zze(b10)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }
