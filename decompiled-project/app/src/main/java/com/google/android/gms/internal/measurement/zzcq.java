    ...
    public final boolean zza(int i7, Parcel parcel, Parcel parcel2, int i10) {
        ...
        switch (i7) {
            case 1:
                ...
                zzbn.zzf(parcel);
                initialize(h10, zzddVar, readLong);
            ...
            case 4:
                ...
                zzbn.zzf(parcel);
                setUserProperty(readString5, readString6, h11, zza3, readLong4);
                parcel2.writeNoException();
                return true;
            case 5:
            ...
            case 15:
                ...
                zzbn.zzf(parcel);
                setCurrentScreen(h12, readString15, readString16, readLong11);
                parcel2.writeNoException();
                return true;
            case 16:
            ...
            case BlurFactor.DEFAULT_RADIUS /* 25 */:
                ...
                zzbn.zzf(parcel);
                onActivityStarted(h13, readLong14);
                parcel2.writeNoException();
                return true;
            case 26:
                ...
                zzbn.zzf(parcel);
                onActivityStopped(h14, readLong15);
                parcel2.writeNoException();
                return true;
            case 27:
                ...
                zzbn.zzf(parcel);
                onActivityCreated(h15, bundle5, readLong16);
                parcel2.writeNoException();
                return true;
            case 28:
                ...
                zzbn.zzf(parcel);
                onActivityDestroyed(h16, readLong17);
                parcel2.writeNoException();
                return true;
            case 29:
                ...
                zzbn.zzf(parcel);
                onActivityPaused(h17, readLong18);
                parcel2.writeNoException();
                return true;
            case 30:
                ...
                zzbn.zzf(parcel);
                onActivityResumed(h18, readLong19);
                parcel2.writeNoException();
                return true;
            case 31:
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceState(h19, zzcuVar7, readLong20);
                parcel2.writeNoException();
                return true;
            case 32:
            ...
            case 33:
                ...
                zzbn.zzf(parcel);
                logHealthData(readInt, readString19, h20, h21, h22);
                parcel2.writeNoException();
                return true;
            case 34:
