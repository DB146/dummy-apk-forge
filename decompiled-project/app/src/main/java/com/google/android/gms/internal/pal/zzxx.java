...
public final class zzxx {
    ...
    public static KeyPair zzc(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) zzxz.zzf.zza("EC");
        keyPairGenerator.initialize(eCParameterSpec);
        return keyPairGenerator.generateKeyPair();
    }

    public static void zzd(ECPoint eCPoint, EllipticCurve ellipticCurve) {
    ...
    public static void zze(ECPublicKey eCPublicKey, ECPrivateKey eCPrivateKey) {
        zzf(eCPublicKey, eCPrivateKey);
        zzd(eCPublicKey.getW(), eCPrivateKey.getParams().getCurve());
    }

    public static void zzf(ECPublicKey eCPublicKey, ECPrivateKey eCPrivateKey) {
        try {
    ...
    public static byte[] zzg(ECPrivateKey eCPrivateKey, ECPublicKey eCPublicKey) {
        zzf(eCPublicKey, eCPrivateKey);
        ECPoint w10 = eCPublicKey.getW();
        zzd(w10, eCPrivateKey.getParams().getCurve());
        PublicKey generatePublic = ((KeyFactory) zzxz.zzg.zza("EC")).generatePublic(new ECPublicKeySpec(w10, eCPrivateKey.getParams()));
                ...
                if (zzb.testBit(0) && zzb.testBit(1)) {
                    ...
                    while (true) {
                        ...
                        if (modPow.add(bigInteger3).equals(zzb)) {
                            ...
                            i7++;
                            if (i7 == 128 && !zzb.isProbablePrime(80)) {
                                throw new InvalidAlgorithmParameterException("p is not prime");
                            }
                        }
                    }
    ...
    public static ECPrivateKey zzh(int i7, byte[] bArr) {
        return (ECPrivateKey) ((KeyFactory) zzxz.zzg.zza("EC")).generatePrivate(new ECPrivateKeySpec(new BigInteger(1, bArr), zzk(i7)));
    }

    public static ECPublicKey zzi(int i7, byte[] bArr, byte[] bArr2) {
        ECParameterSpec zzk = zzk(i7);
    ...
    public static ECPublicKey zzj(ECParameterSpec eCParameterSpec, int i7, byte[] bArr) {
