...
public final class zzkf {
    ...
    private zzkf(String str, Uri uri, String str2, String str3, boolean z8, boolean z10, boolean z11, boolean z12, i iVar) {
        this.zza = uri;
        this.zzb = "";
        this.zzc = "";
        this.zzd = z8;
    ...
    public final zzkl zzd(String str, boolean z8) {
