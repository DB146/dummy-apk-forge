...
final class zznj extends zzoz {
    ...
    public final /* bridge */ /* synthetic */ zzaef zza(zzaef zzaefVar) {
        ...
        zzd.zzb(0);
        zzd.zza(zztwVar.zze());
        zzd.zzc(zzaby.zzn(w10.getAffineX().toByteArray()));
        zzd.zzd(zzaby.zzn(w10.getAffineY().toByteArray()));
        zzuf zzufVar = (zzuf) zzd.zzan();
        zzub zzc2 = zzuc.zzc();
        zzc2.zzc(0);
        zzc2.zzb(zzufVar);
        zzc2.zza(zzaby.zzn(eCPrivateKey.getS().toByteArray()));
