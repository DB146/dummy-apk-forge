...
public final class zzcz {
    ...
    private zzcz(String str, Uri uri, String str2, String str3, boolean z8, boolean z10, boolean z11, boolean z12, zzdg zzdgVar) {
        this.zza = uri;
        this.zzb = "";
        this.zzc = "";
        this.zzd = z8;
    ...
    public final zzdc zze(String str, boolean z8) {
        return new zzcw(this, str, Boolean.valueOf(z8), true);
    }
