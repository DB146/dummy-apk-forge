...
final class zzadu extends zzabj implements RandomAccess, zzadf, zzaem {
    private static final zzadu zza;
    private long[] zzb;
    private int zzc;

    static {
        zzadu zzaduVar = new zzadu(new long[0], 0);
        zza = zzaduVar;
        zzaduVar.zzb();
    }
    ...
    private zzadu(long[] jArr, int i7) {
        this.zzb = jArr;
        this.zzc = i7;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (!(collection instanceof zzadu)) {
            return super.addAll(collection);
        }
        zzadu zzaduVar = (zzadu) collection;
        int i7 = zzaduVar.zzc;
        if (i7 == 0) {
            return false;
        }
        ...
        System.arraycopy(zzaduVar.zzb, 0, this.zzb, this.zzc, zzaduVar.zzc);
        this.zzc = i11;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzaduVar.zzc) {
            return false;
        }
        long[] jArr = zzaduVar.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i10 = 0; i10 < this.zzc; i10++) {
            i7 = (i7 * 31) + zzadg.zzc(this.zzb[i10]);
        }
        return i7;
    }
    ...
    public final /* bridge */ /* synthetic */ zzadf zzd(int i7) {
        if (i7 >= this.zzc) {
            return new zzadu(Arrays.copyOf(this.zzb, i7), this.zzc);
        }
