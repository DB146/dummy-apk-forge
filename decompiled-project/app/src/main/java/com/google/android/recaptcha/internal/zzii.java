...
public final class zzii implements zzih {
    ...
    private final Map zzb = B.H(new j(2, Context.ACTIVITY_SERVICE), new j(3, Context.TELEPHONY_SERVICE), new j(4, Context.INPUT_METHOD_SERVICE), new j(5, Context.AUDIO_SERVICE));
